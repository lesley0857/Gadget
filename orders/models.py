...
def generate_order_number():
    ...
    date_part = timezone.now().strftime(
        "%Y%m%d"
    )
...
class Order(models.Model):
    ...
    negotiation = models.ForeignKey(NegotiationRequest,on_delete=models.SET_NULL,null=True,blank=True,related_name="orders")
    locked_data = models.JSONField(null=True, blank=True)
    requires_shipping_negotiation=models.BooleanField(default=True)
